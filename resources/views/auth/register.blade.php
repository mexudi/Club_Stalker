                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                           <label for="school" class="col-md-4 col-form-label text-md-end">{{ __('School') }}</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="school" value="SEE" id="SEE">
                                    <label class="form-check-label" for="SEE">
                                        SEE
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="school" value="SBA" id="SBA" checked>
                                    <label class="form-check-label" for="SBA">
                                        SBA
                                    </label>
                                </div>
                                 <div class="form-check">
                                    <input class="form-check-input" type="radio" name="school" value="SHSS" id="SHSS" checked>
                                    <label class="form-check-label" for="SHSS">
                                        SHSS
                                    </label>
                                </div>
                            </div>
